        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Box1 = table.Column<int>(type: "int", nullable: false),
                    Box2 = table.Column<int>(type: "int", nullable: false),
                    Box3 = table.Column<int>(type: "int", nullable: false),
                    Box4 = table.Column<int>(type: "int", nullable: false),
                    Box5 = table.Column<int>(type: "int", nullable: false),
                    Box6 = table.Column<int>(type: "int", nullable: false),
                    Box7 = table.Column<int>(type: "int", nullable: false),
                    Box8 = table.Column<int>(type: "int", nullable: false),
                    Box9 = table.Column<int>(type: "int", nullable: false),
                    win = table.Column<int>(type: "int", nullable: true)
                }/*,
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicTacToeMoves", x => x.Game_id);
                }*/
                );
            var createProcSql = @"EXEC(
            ...
            //Это добавление процедуры пока не работает. Добавлял через ssms.
        }
